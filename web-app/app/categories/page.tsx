...
const COPIES_PER_IMAGE = 6; // Total 48 Bilder wie in Home
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-white text-zinc-900">
        ...
        <div className="panel w-full max-w-5xl">
          ...
          <div className="card-slim mb-6 grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <input className="input-slim" placeholder="Category name or description..." value={query} onChange={(e) => setQuery(e.target.value)} />
            </div>
            <div>
              ...
              <table className="w-full text-left text-sm border-collapse">
                <thead>
                  <tr className="bg-zinc-50/50">
                    ...
                    <th className="p-4 font-black uppercase text-[10px] text-zinc-400 tracking-wider border-b border-zinc-100">Category Name</th>
                    <th className="p-4 font-black uppercase text-[10px] text-zinc-400 tracking-wider border-b border-zinc-100">Description</th>
                  </tr>
                </thead>
      ...
      <style>{`
        ...
        .fly{ position: absolute; border-radius: 14px; box-shadow: 0 10px 25px rgba(0,0,0,0.1); will-change: transform; pointer-events: none; }
