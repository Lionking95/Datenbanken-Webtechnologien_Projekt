...
export default function CreateCustomerPage() {
  ...
  // Background Animation Logic (Exact match with Category/Home)
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      setMsg(`✅ Customer created successfully${data?.insertId ? ` (ID: ${data.insertId})` : ""}`);
      setCustomerName(""); setContactName(""); setCity(""); setCountry("");
    } catch (err: any) {
      ...
      <main className="relative z-10 flex min-h-screen items-center justify-center px-6 py-12">
        <div className="panel w-full max-w-xl">
          <div className="flex items-center justify-between mb-8">
            <div>
              <h1 className="text-xl font-bold tracking-tight">Create Customer</h1>
              <p className="text-[10px] text-zinc-400 uppercase font-black mt-1 tracking-widest">Add new customer</p>
            </div>
